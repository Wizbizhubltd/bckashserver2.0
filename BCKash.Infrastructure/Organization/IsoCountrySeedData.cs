...
/// <summary>
/// Standard ISO 3166-1 alpha-2 country list — genuine, universal reference data (not
/// business-specific), used to seed `countries` since no legacy data rows exist to
/// migrate (see Phase 1 plan notes). `Sortname`/`Name` match `countries.sortname`/`name`.
/// </summary>
public static class IsoCountrySeedData
{
    public static readonly IReadOnlyList<(string Sortname, string Name)> Countries =
    [
