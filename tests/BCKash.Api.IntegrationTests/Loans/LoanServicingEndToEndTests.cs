...
public class LoanServicingEndToEndTests : IClassFixture<BCKashWebApplicationFactory>
{
    ...
    public async Task Client_to_loan_to_disbursement_to_mixed_repayments_matches_hand_calculated_expectations()
    {
        ...
        var applicationResponse = await client.PostAsJsonAsync("/api/v1/loan-applications", applicationRequest);
        ...
        // 4. Approve.
        var approveResponse = await client.PostAsJsonAsync($"/api/v1/loan-applications/{application.Id}/approve", new ApproveLoanApplicationRequest(12000m, "Approved for end-to-end test"));
        ...
        var initialSchedule = await client.GetFromJsonAsync<List<ScheduleInstallmentResponse>>($"/api/v1/loans/{loanId}/schedule", TestJson.Options);
        ...
        var onTime = await client.PostAsJsonAsync($"/api/v1/loans/{loanId}/repayments", new RecordRepaymentRequest(1120m, null, new DateOnly(2026, 1, 28), "On-time"));
        ...
        var late = await client.PostAsJsonAsync($"/api/v1/loans/{loanId}/repayments", new RecordRepaymentRequest(1120m, null, new DateOnly(2026, 3, 22), "Late"));
        ...
        var partial1 = await client.PostAsJsonAsync($"/api/v1/loans/{loanId}/repayments", new RecordRepaymentRequest(600m, null, new DateOnly(2026, 4, 5), "Partial 1"));
        ...
        var partial2 = await client.PostAsJsonAsync($"/api/v1/loans/{loanId}/repayments", new RecordRepaymentRequest(520m, null, new DateOnly(2026, 4, 20), "Partial 2"));
        ...
        var finalSchedule = await client.GetFromJsonAsync<List<ScheduleInstallmentResponse>>($"/api/v1/loans/{loanId}/schedule", TestJson.Options);
